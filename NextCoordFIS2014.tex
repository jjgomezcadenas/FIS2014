...
\subsection{\sc DATOS DE LOS SUBPROYECTOS/ DATA OF SUBPROJECTS }
...
\item {\bf Título / Title}: Coordination NEXT project (COORD)
\end{itemize}
...
\subsection{\sc RELACIÓN DE LAS PERSONAS NO DOCTORES QUE COMPONEN EL EQUIPO DE TRABAJO / WORKING TEAM (NO Ph.D) }
\input{src2/RelacionNoDoctores.tex}

\subsection{\sc FINANCIACIÓN PÚBLICA Y PRIVADA (PROYECTOS Y/O CONTRATOS DE I+D+I) DEL EQUIPO DE INVESTIGACIÓN / FUNDING OF RESEARCH TEAM}
