...
\input{src/Objectives2.tex}
\input{src/ObjCoord.tex}
\input{src/ObjElec.tex}
\input{src/ObjectivesCalRec.tex}
\input{src/NextSchedule.tex}
\input{src/ObjBata.tex}
\input{src/BataSchedule.tex}


\subsection*{\sc Infraestructuras y equipos/Infrastructures and equipment}
\input{src/Equipment.tex}
