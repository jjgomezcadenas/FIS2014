...
%({\it 14 citations}).
%\end{itemize}
%Two papers are selected to represent the extensive work that the researcher has carried out in the field of future neutrino facilities, where he continues active. The first is a renowned paper where the golden signature of muons in a neutrino factory is proposed and the concept of the magnetic detector to detect them is layed out. This paper was published in 2000, but is quoted here for two reasons: first, it created a new subfield (that of the study of the golden channel), which has span hundreds of articles over the last 14 years. Second, we have recently revisited our results of 2000, publishing them in a recent paper of 2012, confirming the very good physics potential found at the time with a much more sophisticated simulation and analysis.  
